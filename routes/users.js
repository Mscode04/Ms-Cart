...
router.get('/', function(req, res, next) {
  const phones = [
    ...
    },
    {
      ...
      description: "High-performance, budget-friendly phfergfrfgtdfrsdefrgrtgtfgyrtftrtytyht6y6tyone with 144Hz display and Snapdragon 8+ fdefrygtGen 1.",
  ...
  res.render('index', { phones ,admin:false});
});
